...
public class NetworkServiceImpl implements NetworkService {
    ...
    public void disconnectAllContainers(String networkName) {
        try {
            // 1. 查找对应的网络
            ...
            if (containers == null || containers.isEmpty()) {
                System.out.println("网络 " + networkName + " 上没有容器连接。");
                return;
            }
            ...
            for (Map.Entry<String, Network.ContainerNetworkConfig> entry : containers.entrySet()) {
                String containerId = entry.getKey();
                String containerName = entry.getValue().getName();
                ...
                System.out.println("已断开容器：" + containerName + "（ID: " + containerId + "）");
            }
