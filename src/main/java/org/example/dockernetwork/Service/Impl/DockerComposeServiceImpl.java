...
public class DockerComposeServiceImpl implements DockerComposeService {
    ...
    private void generateFile(List<DockerContainer> dockerContainers, List<DockerNetwork> dockerNetworks, List<String> oldNetworks) throws IOException {
    ...
    private void executeCommand(String filePath) {
